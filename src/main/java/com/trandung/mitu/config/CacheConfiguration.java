package com.trandung.mitu.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.trandung.mitu.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.trandung.mitu.repository.UserRepository.USERS_BY_EMAIL_CACHE);
